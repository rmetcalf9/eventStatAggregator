...
export APIAPP_MQCLIENTCONFIG="{ \"Type\": \"Stomp\", \"ConnectionString\": \"stomp://127.0.0.1:61613\", \"Username\": \"eventStatMsgProc\", \"Password\": \"eventStatMsgProcPass\", \"clientId\": \"run_msgproc_developer\" }"
